					...
					case SupportedProfiles.PowerTransformer:
						{
							...
							TransformAndLoadReport report = FTN_93_ProfileImporter.Instance.CreateNMSDelta(concreteModel);

							if (report.Success)
							{
								nmsDelta = FTN_93_ProfileImporter.Instance.NMSDelta;
								success = true;
							}
							else
							{
							...
							FTN_93_ProfileImporter.Instance.Reset();
